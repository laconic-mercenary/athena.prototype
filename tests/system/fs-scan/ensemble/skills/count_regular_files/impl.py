"""Skill: count_regular_files — count non-hidden files by extension."""
...
def count_regular_files(directory: str, extensions: list[str]) -> dict:
    """Walk directory and count files whose name does NOT start with '.'."""
